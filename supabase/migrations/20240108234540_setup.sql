...
AS $$
DECLARE
  project_url TEXT := 'https://ghtgibvqubbmcxrkwswv.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImdodGdpYnZxdWJibWN4cmt3c3d2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwOTM4MzgxOSwiZXhwIjoyMDI0OTU5ODE5fQ.nYuL6S3oUfBlmu5ZODymGm7OD7BEsCVUj7W-41wnLb8'; -- full access needed for http request to storage
